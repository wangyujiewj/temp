...
class CrossAttentionalGNN(nn.Module):
    def __init__(self, feature_dim):
        super().__init__()
        self.layer1 = AttentionalPropagation(feature_dim, 4)
        self.layer2 = AttentionalPropagation(feature_dim, 4)
    def forward(self, desc0, desc1):
        # 二分图
        src0, src1 = desc1, desc0
        delta0, delta1 = self.layer1(desc0, src0), self.layer2(desc1, src1)
