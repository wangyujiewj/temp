...
class LGCNN(nn.Module):
    def __init__(self, n_emb_dims=512):
        super(LGCNN, self).__init__()
        self.conv1 = nn.Conv2d(6, 64, kernel_size=1, bias=False)
        self.conv2 = nn.Conv2d(67, 64, kernel_size=1, bias=False)
        self.conv3 = nn.Conv2d(131, 64, kernel_size=1, bias=False)
        self.conv4 = nn.Conv2d(195, 128, kernel_size=1, bias=False)
...
class MatchNet(nn.Module):
    def __init__(self, args):
        ...
        for i in range(self.n_iters):
            layer = LGCNN(n_emb_dims=self.n_emb_dims)
