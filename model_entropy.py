...
from function import EntropyLoss
...
class MatchNet(nn.Module):
    ...
    def forward(self, *input):
        ...
        src_embedding_k, src_k, sample_scores = sampling(src_embedding, src, temp)
...
class HMNet(nn.Module):
    ...
    def forward(self, *input):
        rotation_ab, translation_ab, sample_scores = self.match_net(*input)
        return rotation_ab, translation_ab, sample_scores
